...
<head>
    ...
    <style>
        ...
        .navbar-kumparan .nav-icons .login-btn, .navbar-kumparan .nav-icons .logout-btn {
    ...
    <nav class="navbar-kumparan">
        <div class="nav-main">
            ...
            <div class="nav-icons">
                ...
                <button class="login-btn" onclick="alert('Login dummy!')">wisnu</button>
                <button class="logout-btn" onclick="alert('Logout dummy!')">ganteng</button>
            </div>
        </div>
        <div class="nav-menu">
            <a href="#">News</a>
